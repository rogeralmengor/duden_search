...
* [Arparse](https://docs.python.org/3/library/argparse.html)(Python3-Standard-Bibliothek)
* [html_to_json](https://github.com/fhightower/html-to-json)
* [tempfile](https://docs.python.org/3/library/tempfile.html)(Python3-Standard-Bibliothek)
